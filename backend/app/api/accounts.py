...
async def create_account(
    ...
    return await account_service.create_account(db, data, created_by_id=current_user["id"])
...
async def update_account(
    ...
    return await account_service.update_account(db, account_id, data, updated_by_id=current_user["id"])
