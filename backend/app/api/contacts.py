...
async def get_contact(
    ...
    return await contact_service.get_contact_by_id(db, contact_id)
...
async def create_contact(
    ...
    return await contact_service.create_contact(db, data, created_by_id=current_user["id"])
...
async def update_contact(
    ...
    return await contact_service.update_contact(db, contact_id, data, updated_by_id=current_user["id"])
